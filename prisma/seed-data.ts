...
export interface TeamDef {
  name: string
  color: string
  manager: { firstName: string; lastName: string; email?: string; jobTitle: string; phone: string }
  employees: { firstName: string; lastName: string; jobTitle: string; weeklyHours: number; hireDate: string; phone: string }[]
}
...
export const TECHCORP_TEAMS: TeamDef[] = [
  {
    ...
    manager: { firstName: 'Jane', lastName: 'Smith', email: 'jane.smith@techcorp.com', jobTitle: 'Responsable Bazar', phone: '+33 6 12 34 56 78' },
    employees: [
      // Bob Wilson = E2E user, conservé comme EMPLOYEE
      { firstName: 'Bob', lastName: 'Wilson', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2021-04-10', phone: '+33 6 23 45 67 89' },
      { firstName: 'Arnaud', lastName: 'Fabre', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2020-09-01', phone: '+33 6 34 56 78 90' },
      { firstName: 'Céline', lastName: 'Mercier', jobTitle: 'Employée libre-service', weeklyHours: 30, hireDate: '2022-01-15', phone: '+33 6 45 67 89 01' },
      { firstName: 'Damien', lastName: 'Blanc', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2019-06-01', phone: '+33 6 56 78 90 12' },
      { firstName: 'Émilie', lastName: 'Renaud', jobTitle: 'Employée libre-service', weeklyHours: 32, hireDate: '2023-03-01', phone: '+33 6 67 89 01 23' },
      { firstName: 'Florian', lastName: 'Chevalier', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2021-11-15', phone: '+33 6 78 90 12 34' },
      { firstName: 'Géraldine', lastName: 'Fontaine', jobTitle: 'Employée libre-service', weeklyHours: 30, hireDate: '2024-01-08', phone: '+33 6 89 01 23 45' },
      { firstName: 'Hugo', lastName: 'Maréchal', jobTitle: 'Employé libre-service', weeklyHours: 39, hireDate: '2018-05-01', phone: '+33 6 90 12 34 56' },
    ],
  },
  {
    name: 'Secrétariat',
    color: '#6366F1',
    manager: { firstName: 'Marie', lastName: 'Lefèvre', jobTitle: 'Responsable Secrétariat', phone: '+33 6 11 22 33 44' },
    employees: [
      { firstName: 'Agathe', lastName: 'Caron', jobTitle: 'Secrétaire', weeklyHours: 35, hireDate: '2020-03-01', phone: '+33 6 22 33 44 55' },
      { firstName: 'Benoît', lastName: 'Picard', jobTitle: 'Assistant administratif', weeklyHours: 35, hireDate: '2021-09-01', phone: '+33 6 33 44 55 66' },
      { firstName: 'Claire', lastName: 'Hubert', jobTitle: 'Secrétaire', weeklyHours: 32, hireDate: '2022-06-01', phone: '+33 6 44 55 66 77' },
      { firstName: 'Denis', lastName: 'Vasseur', jobTitle: 'Assistant de direction', weeklyHours: 39, hireDate: '2019-01-15', phone: '+33 6 55 66 77 88' },
      { firstName: 'Élise', lastName: 'Bonnet', jobTitle: 'Secrétaire', weeklyHours: 30, hireDate: '2023-10-01', phone: '+33 6 66 77 88 99' },
    ],
  },
  {
    name: 'Ressources Humaines',
    color: '#EC4899',
    manager: { firstName: 'Sophie', lastName: 'Martin', jobTitle: 'Responsable RH', phone: '+33 6 10 20 30 40' },
    employees: [
      { firstName: 'Antoine', lastName: 'Garnier', jobTitle: 'Chargé de recrutement', weeklyHours: 35, hireDate: '2020-06-01', phone: '+33 6 20 30 40 50' },
      { firstName: 'Brigitte', lastName: 'Perrin', jobTitle: 'Gestionnaire paie', weeklyHours: 35, hireDate: '2019-03-15', phone: '+33 6 30 40 50 60' },
      { firstName: 'Christelle', lastName: 'Morel', jobTitle: 'Chargée de formation', weeklyHours: 35, hireDate: '2021-01-10', phone: '+33 6 40 50 60 70' },
      { firstName: 'David', lastName: 'Fournier', jobTitle: 'Assistant RH', weeklyHours: 32, hireDate: '2023-09-01', phone: '+33 6 50 60 70 80' },
      { firstName: 'Estelle', lastName: 'Simon', jobTitle: 'Assistante RH', weeklyHours: 30, hireDate: '2024-02-01', phone: '+33 6 60 70 80 90' },
    ],
  },
  {
    name: 'Liquide',
    color: '#3B82F6',
    manager: { firstName: 'Pierre', lastName: 'Durand', jobTitle: 'Responsable Liquide', phone: '+33 6 13 24 35 46' },
    employees: [
      { firstName: 'Alexandre', lastName: 'Robin', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2020-01-15', phone: '+33 6 24 35 46 57' },
      { firstName: 'Barbara', lastName: 'Lemoine', jobTitle: 'Employée libre-service', weeklyHours: 35, hireDate: '2021-05-01', phone: '+33 6 35 46 57 68' },
      { firstName: 'Cédric', lastName: 'Marchand', jobTitle: 'Employé libre-service', weeklyHours: 39, hireDate: '2018-11-01', phone: '+33 6 46 57 68 79' },
      { firstName: 'Delphine', lastName: 'Gautier', jobTitle: 'Employée libre-service', weeklyHours: 30, hireDate: '2022-08-01', phone: '+33 6 57 68 79 80' },
      { firstName: 'Éric', lastName: 'Leclerc', jobTitle: 'Cariste', weeklyHours: 35, hireDate: '2019-07-01', phone: '+33 6 68 79 80 91' },
      { firstName: 'Fabienne', lastName: 'Roche', jobTitle: 'Employée libre-service', weeklyHours: 32, hireDate: '2023-01-15', phone: '+33 6 79 80 91 02' },
      { firstName: 'Grégory', lastName: 'Adam', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2020-10-01', phone: '+33 6 80 91 02 13' },
      { firstName: 'Hélène', lastName: 'Henry', jobTitle: 'Employée libre-service', weeklyHours: 35, hireDate: '2021-03-01', phone: '+33 6 91 02 13 24' },
      { firstName: 'Ivan', lastName: 'Masson', jobTitle: 'Cariste', weeklyHours: 39, hireDate: '2018-04-01', phone: '+33 6 02 13 24 35' },
      { firstName: 'Julie', lastName: 'Moulin', jobTitle: 'Employée libre-service', weeklyHours: 30, hireDate: '2024-03-01', phone: '+33 6 13 25 36 47' },
    ],
  },
  {
    name: 'Épicerie',
    color: '#22C55E',
    manager: { firstName: 'Nathalie', lastName: 'Rousseau', jobTitle: 'Responsable Épicerie', phone: '+33 6 14 25 36 47' },
    employees: [
      { firstName: 'Adrien', lastName: 'Guillot', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2019-05-01', phone: '+33 6 25 36 47 58' },
      { firstName: 'Blandine', lastName: 'Lecomte', jobTitle: 'Employée libre-service', weeklyHours: 35, hireDate: '2020-07-01', phone: '+33 6 36 47 58 69' },
      { firstName: 'Corentin', lastName: 'Dufour', jobTitle: 'Employé libre-service', weeklyHours: 39, hireDate: '2018-09-01', phone: '+33 6 47 58 69 70' },
      { firstName: 'Diana', lastName: 'Breton', jobTitle: 'Employée libre-service', weeklyHours: 30, hireDate: '2022-11-01', phone: '+33 6 58 69 70 81' },
      { firstName: 'Emmanuel', lastName: 'Legrand', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2021-02-15', phone: '+33 6 69 70 81 92' },
      { firstName: 'Françoise', lastName: 'Collet', jobTitle: 'Employée libre-service', weeklyHours: 32, hireDate: '2023-04-01', phone: '+33 6 70 81 92 03' },
      { firstName: 'Gabriel', lastName: 'Meunier', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2020-12-01', phone: '+33 6 81 92 03 14' },
      { firstName: 'Hortense', lastName: 'Rivière', jobTitle: 'Employée libre-service', weeklyHours: 35, hireDate: '2019-08-01', phone: '+33 6 92 03 14 25' },
      { firstName: 'Igor', lastName: 'Dupuis', jobTitle: 'Cariste', weeklyHours: 39, hireDate: '2018-02-01', phone: '+33 6 03 14 25 36' },
      { firstName: 'Justine', lastName: 'Aubert', jobTitle: 'Employée libre-service', weeklyHours: 30, hireDate: '2024-05-01', phone: '+33 6 14 26 37 48' },
      { firstName: 'Kévin', lastName: 'Pichon', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2021-10-01', phone: '+33 6 26 37 48 59' },
      { firstName: 'Laure', lastName: 'Gérard', jobTitle: 'Employée libre-service', weeklyHours: 32, hireDate: '2022-03-01', phone: '+33 6 37 48 59 60' },
    ],
  },
  {
    name: 'Multimédia',
    color: '#8B5CF6',
    manager: { firstName: 'Karim', lastName: 'Benali', jobTitle: 'Responsable Multimédia', phone: '+33 6 15 26 37 48' },
    employees: [
      { firstName: 'Alexis', lastName: 'Barbier', jobTitle: 'Vendeur multimédia', weeklyHours: 35, hireDate: '2020-04-01', phone: '+33 6 26 38 49 50' },
      { firstName: 'Béatrice', lastName: 'Rolland', jobTitle: 'Vendeuse multimédia', weeklyHours: 35, hireDate: '2021-06-15', phone: '+33 6 37 49 50 61' },
      { firstName: 'Cyril', lastName: 'Bouvier', jobTitle: 'Technicien SAV', weeklyHours: 35, hireDate: '2019-11-01', phone: '+33 6 48 50 61 72' },
      { firstName: 'Dorothée', lastName: 'Arnaud', jobTitle: 'Vendeuse multimédia', weeklyHours: 32, hireDate: '2022-09-01', phone: '+33 6 59 61 72 83' },
      { firstName: 'Étienne', lastName: 'Charpentier', jobTitle: 'Vendeur multimédia', weeklyHours: 39, hireDate: '2018-07-01', phone: '+33 6 60 72 83 94' },
      { firstName: 'Fanny', lastName: 'Guérin', jobTitle: 'Vendeuse multimédia', weeklyHours: 30, hireDate: '2023-06-01', phone: '+33 6 71 83 94 05' },
      { firstName: 'Guillaume', lastName: 'Lacroix', jobTitle: 'Vendeur multimédia', weeklyHours: 35, hireDate: '2021-01-15', phone: '+33 6 82 94 05 16' },
    ],
  },
  {
    name: 'Hygiène',
    color: '#14B8A6',
    manager: { firstName: 'Christine', lastName: 'Lambert', jobTitle: 'Responsable Hygiène', phone: '+33 6 16 27 38 49' },
    employees: [
      { firstName: 'Aurélien', lastName: 'Berger', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2020-02-01', phone: '+33 6 27 39 40 51' },
      { firstName: 'Camille', lastName: 'Richard', jobTitle: 'Employée libre-service', weeklyHours: 35, hireDate: '2021-08-01', phone: '+33 6 38 40 51 62' },
      { firstName: 'Damien', lastName: 'Muller', jobTitle: 'Employé libre-service', weeklyHours: 30, hireDate: '2022-04-01', phone: '+33 6 49 51 62 73' },
      { firstName: 'Élodie', lastName: 'Schmitt', jobTitle: 'Employée libre-service', weeklyHours: 35, hireDate: '2019-12-01', phone: '+33 6 50 62 73 84' },
      { firstName: 'Fabrice', lastName: 'Poulain', jobTitle: 'Employé libre-service', weeklyHours: 39, hireDate: '2018-08-01', phone: '+33 6 61 73 84 95' },
      { firstName: 'Gisèle', lastName: 'Renard', jobTitle: 'Employée libre-service', weeklyHours: 32, hireDate: '2023-07-01', phone: '+33 6 72 84 95 06' },
      { firstName: 'Hervé', lastName: 'Philippe', jobTitle: 'Employé libre-service', weeklyHours: 35, hireDate: '2020-11-01', phone: '+33 6 83 95 06 17' },
      { firstName: 'Inès', lastName: 'David', jobTitle: 'Employée libre-service', weeklyHours: 30, hireDate: '2024-04-01', phone: '+33 6 94 06 17 28' },
    ],
  },
  {
    name: 'Réception marchandises',
    color: '#F97316',
    manager: { firstName: 'Yannick', lastName: 'Moreau', jobTitle: 'Responsable Réception', phone: '+33 6 17 28 39 40' },
    employees: [
      { firstName: 'Alain', lastName: 'Brun', jobTitle: 'Réceptionnaire', weeklyHours: 39, hireDate: '2019-02-01', phone: '+33 6 28 40 51 62' },
      { firstName: 'Brigitte', lastName: 'Lejeune', jobTitle: 'Réceptionnaire', weeklyHours: 35, hireDate: '2020-05-01', phone: '+33 6 39 51 62 73' },
      { firstName: 'Claude', lastName: 'Poirier', jobTitle: 'Cariste', weeklyHours: 39, hireDate: '2018-10-01', phone: '+33 6 40 62 73 84' },
      { firstName: 'Dominique', lastName: 'Tanguy', jobTitle: 'Réceptionnaire', weeklyHours: 35, hireDate: '2021-07-01', phone: '+33 6 51 73 84 95' },
      { firstName: 'Eugène', lastName: 'Coulon', jobTitle: 'Cariste', weeklyHours: 39, hireDate: '2019-09-01', phone: '+33 6 62 84 95 06' },
      { firstName: 'Florence', lastName: 'Millet', jobTitle: 'Réceptionnaire', weeklyHours: 35, hireDate: '2022-02-01', phone: '+33 6 73 95 06 17' },
    ],
  },
  {
    name: 'Boulangerie-Pâtisserie',
    color: '#A855F7',
    manager: { firstName: 'Isabelle', lastName: 'Petit', jobTitle: 'Responsable Boulangerie', phone: '+33 6 18 29 30 41' },
    employees: [
      { firstName: 'André', lastName: 'Carpentier', jobTitle: 'Boulanger', weeklyHours: 39, hireDate: '2018-03-01', phone: '+33 6 29 41 52 63' },
      { firstName: 'Bérangère', lastName: 'Vidal', jobTitle: 'Pâtissière', weeklyHours: 35, hireDate: '2019-10-01', phone: '+33 6 30 52 63 74' },
      { firstName: 'Charles', lastName: 'Maillard', jobTitle: 'Boulanger', weeklyHours: 39, hireDate: '2020-06-01', phone: '+33 6 41 63 74 85' },
      { firstName: 'Diane', lastName: 'Leclercq', jobTitle: 'Vendeuse boulangerie', weeklyHours: 30, hireDate: '2022-05-01', phone: '+33 6 52 74 85 96' },
      { firstName: 'Edmond', lastName: 'Prévost', jobTitle: 'Boulanger', weeklyHours: 39, hireDate: '2018-12-01', phone: '+33 6 63 85 96 07' },
      { firstName: 'Fleur', lastName: 'Baron', jobTitle: 'Pâtissière', weeklyHours: 35, hireDate: '2021-04-01', phone: '+33 6 74 96 07 18' },
      { firstName: 'Gaston', lastName: 'Humbert', jobTitle: 'Boulanger', weeklyHours: 39, hireDate: '2019-06-01', phone: '+33 6 85 07 18 29' },
      { firstName: 'Henriette', lastName: 'Jacquet', jobTitle: 'Vendeuse boulangerie', weeklyHours: 32, hireDate: '2023-02-01', phone: '+33 6 96 18 29 30' },
      { firstName: 'Irène', lastName: 'Navarro', jobTitle: 'Pâtissière', weeklyHours: 35, hireDate: '2024-06-01', phone: '+33 6 07 29 30 41' },
    ],
  },
  {
    name: 'Textile',
    color: '#EF4444',
    manager: { firstName: 'Sandrine', lastName: 'Girard', jobTitle: 'Responsable Textile', phone: '+33 6 19 20 31 42' },
    employees: [
      { firstName: 'Arthur', lastName: 'Lemaire', jobTitle: 'Vendeur textile', weeklyHours: 35, hireDate: '2020-08-01', phone: '+33 6 20 32 43 54' },
      { firstName: 'Bénédicte', lastName: 'Cordier', jobTitle: 'Vendeuse textile', weeklyHours: 35, hireDate: '2021-12-01', phone: '+33 6 31 43 54 65' },
      { firstName: 'Clément', lastName: 'Royer', jobTitle: 'Vendeur textile', weeklyHours: 30, hireDate: '2022-10-01', phone: '+33 6 42 54 65 76' },
      { firstName: 'Doriane', lastName: 'Maury', jobTitle: 'Vendeuse textile', weeklyHours: 32, hireDate: '2023-05-01', phone: '+33 6 53 65 76 87' },
      { firstName: 'Erwan', lastName: 'Gilles', jobTitle: 'Vendeur textile', weeklyHours: 35, hireDate: '2019-04-01', phone: '+33 6 64 76 87 98' },
      { firstName: 'Gaëlle', lastName: 'Ferreira', jobTitle: 'Vendeuse textile', weeklyHours: 35, hireDate: '2020-11-15', phone: '+33 6 75 87 98 09' },
      { firstName: 'Hubert', lastName: 'Pascal', jobTitle: 'Vendeur textile', weeklyHours: 39, hireDate: '2018-06-01', phone: '+33 6 86 98 09 10' },
    ],
  },
  {
    name: 'Caisses et Accueil',
    color: '#0EA5E9',
    manager: { firstName: 'Valérie', lastName: 'Dupont', jobTitle: 'Responsable Caisses', phone: '+33 6 10 21 32 43' },
    employees: [
      { firstName: 'Amandine', lastName: 'Pons', jobTitle: 'Caissière', weeklyHours: 30, hireDate: '2020-01-01', phone: '+33 6 21 33 44 55' },
      { firstName: 'Bastien', lastName: 'Rémy', jobTitle: 'Caissier', weeklyHours: 35, hireDate: '2021-03-15', phone: '+33 6 32 44 55 66' },
      { firstName: 'Camille', lastName: 'Torres', jobTitle: 'Hôtesse d\'accueil', weeklyHours: 35, hireDate: '2019-09-01', phone: '+33 6 43 55 66 77' },
      { firstName: 'Dylan', lastName: 'Faure', jobTitle: 'Caissier', weeklyHours: 30, hireDate: '2022-07-01', phone: '+33 6 54 66 77 88' },
      { firstName: 'Eva', lastName: 'Brunet', jobTitle: 'Caissière', weeklyHours: 30, hireDate: '2023-08-01', phone: '+33 6 65 77 88 99' },
      { firstName: 'Florent', lastName: 'Delorme', jobTitle: 'Caissier', weeklyHours: 35, hireDate: '2020-04-15', phone: '+33 6 76 88 99 00' },
      { firstName: 'Gaëtane', lastName: 'Blanchet', jobTitle: 'Caissière', weeklyHours: 30, hireDate: '2021-10-01', phone: '+33 6 87 99 00 11' },
      { firstName: 'Harold', lastName: 'Étienne', jobTitle: 'Agent d\'accueil', weeklyHours: 35, hireDate: '2019-05-01', phone: '+33 6 98 00 11 22' },
      { firstName: 'Iris', lastName: 'Monnier', jobTitle: 'Caissière', weeklyHours: 32, hireDate: '2022-12-01', phone: '+33 6 09 11 22 33' },
      { firstName: 'Joël', lastName: 'Charrier', jobTitle: 'Caissier', weeklyHours: 30, hireDate: '2023-11-01', phone: '+33 6 10 22 33 44' },
      { firstName: 'Katia', lastName: 'Seguin', jobTitle: 'Caissière', weeklyHours: 30, hireDate: '2024-01-15', phone: '+33 6 21 34 45 56' },
      { firstName: 'Ludovic', lastName: 'Allard', jobTitle: 'Caissier', weeklyHours: 35, hireDate: '2020-07-01', phone: '+33 6 32 45 56 67' },
      { firstName: 'Mélanie', lastName: 'Bouchet', jobTitle: 'Caissière', weeklyHours: 30, hireDate: '2021-06-01', phone: '+33 6 43 56 67 78' },
      { firstName: 'Nicolas', lastName: 'Lemoine', jobTitle: 'Agent d\'accueil', weeklyHours: 35, hireDate: '2019-11-01', phone: '+33 6 54 67 78 89' },
      { firstName: 'Ophélie', lastName: 'Joubert', jobTitle: 'Caissière', weeklyHours: 32, hireDate: '2022-09-15', phone: '+33 6 65 78 89 90' },
    ],
  },
  {
    name: 'Comptabilité',
    color: '#10B981',
    manager: { firstName: 'François', lastName: 'Leroy', jobTitle: 'Responsable Comptabilité', phone: '+33 6 11 23 34 45' },
    employees: [
      { firstName: 'Audrey', lastName: 'Colas', jobTitle: 'Comptable', weeklyHours: 35, hireDate: '2019-01-01', phone: '+33 6 22 34 45 56' },
      { firstName: 'Bernard', lastName: 'Tessier', jobTitle: 'Comptable', weeklyHours: 35, hireDate: '2020-09-01', phone: '+33 6 33 45 56 67' },
      { firstName: 'Corinne', lastName: 'Marty', jobTitle: 'Aide-comptable', weeklyHours: 32, hireDate: '2022-01-01', phone: '+33 6 44 56 67 78' },
      { firstName: 'Didier', lastName: 'Laurent', jobTitle: 'Comptable', weeklyHours: 39, hireDate: '2018-01-15', phone: '+33 6 55 67 78 89' },
      { firstName: 'Estelle', lastName: 'Noel', jobTitle: 'Aide-comptable', weeklyHours: 30, hireDate: '2023-03-15', phone: '+33 6 66 78 89 90' },
    ],
  },
]
