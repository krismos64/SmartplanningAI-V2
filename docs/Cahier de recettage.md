...
**Graphique d'évolution** : De 27 tests (04/12) à 5488 tests (06/02) = **+20226% de croissance** 🚀
...
| N°  | Compétence                                                          | Preuve                                                                                                                                                                                                                                                                                                                                                  |
| --- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Tester les composants d'une application                             | 4790 tests unitaires documentés                                                                                                                                                                                                                                                                                                                         |
...
| 5   | Développer des tests automatisés                                    | 5488 tests (unitaires + E2E)                                                                                                                                                                                                                                                                                                                            |
