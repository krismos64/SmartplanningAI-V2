...
export function MobileMockup() {
  return (
    /*
      Deux largeurs distinctes. Le cadre est borne a 19,5rem : a 22rem il
      mesurait 352 px de large pour 449 de haut, ratio 1,27, et se lisait comme
      une tablette. Le prototype tient 313 x 604, ratio 1,93.

      Le conteneur exterieur est plus large (26rem) pour que les etiquettes
      flottantes se posent a cote du telephone et non par-dessus son contenu,
      ou elles masquaient les pastilles d'avatar.
    */
    <div
      aria-hidden="true"
      className="relative mx-auto flex w-full max-w-[26rem] justify-center"
    >
      {/*
      ...
      */}
      <span className="absolute -right-4 top-40 z-20 border-b-4 border-public-brand-surface bg-public-surface px-3 py-2 font-geist text-xs font-semibold text-public-content shadow-lg">
        Planning à jour
      </span>
      <span className="absolute -left-4 bottom-28 z-20 border-b-4 border-public-highlight bg-public-surface px-3 py-2 font-geist text-xs font-semibold text-public-content shadow-lg">
        Congé validé
      </span>

      {/*
        Cadre et aplat d'epaisseur sont groupes : le conteneur exterieur est
        plus large pour laisser respirer les etiquettes flottantes, l'aplat
        doit donc se caler sur le cadre et non sur ce conteneur.
      */}
      <div className="relative w-full max-w-[19.5rem]">
        {/* Aplat bleu decale qui donne l'epaisseur du telephone */}
        <div
          className="absolute inset-y-8 left-10 right-0 translate-x-3 rounded-r-[1.5rem] bg-public-brand-surface"
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 w-full rounded-[2.25rem] border-[6px] border-public-content bg-public-content p-1 shadow-2xl">
          ...
          <div className="overflow-hidden rounded-[1.75rem] bg-public-surface pb-2">
            {/* En-tete */}
            <div className="flex items-start justify-between gap-3 px-4 pb-4 pt-9">
              <div>
            ...
            <div className="mx-4 border-l-4 border-public-highlight bg-public-surface-dark px-4 py-6">
            ...
            <div className="mt-6 space-y-2 px-4">
              {DAYS.map((day) => (
                <div
                  ...
                  className={
                    day.off
                      ? 'flex items-center justify-between border-l-4 border-public-highlight bg-public-highlight-surface px-3 py-3'
                      : 'flex items-center justify-between border-l-4 border-public-brand-surface bg-public-surface-subtle px-3 py-3'
                  }
                >
                  {/*
            ...
            {/* Message d'equipe */}
            <div className="mx-4 mt-5 flex items-start gap-2.5 bg-public-surface-subtle px-3 py-3.5">
              {/*
            ...
            */}
            ...
            {/* Barre de navigation */}
            <div className="mt-5 flex items-center justify-around border-t border-public-border px-2 py-4">
