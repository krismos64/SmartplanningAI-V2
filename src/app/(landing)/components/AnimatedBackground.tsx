...
export function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-10">
      ...
      {/* Animated blobs - monochrome primary */}
      <div className="absolute left-1/4 top-0 h-[500px] w-[500px] animate-pulse rounded-full bg-blue-600/5 blur-[120px] dark:bg-blue-400/10" />
      <div className="absolute bottom-1/4 right-1/4 h-[400px] w-[400px] animate-pulse rounded-full bg-blue-600/5 blur-[120px] delay-1000 dark:bg-blue-400/10" />
