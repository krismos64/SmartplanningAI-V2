...
export function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-10">
      ...
      <div className="absolute bottom-1/4 right-1/4 h-[400px] w-[400px] rounded-full bg-blue-600/5 blur-[120px]" />

      {/* Grid pattern - adapts to light/dark mode */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,.03)_1px,transparent_1px)] bg-[size:100px_100px]" />
    </div>
  )
}
