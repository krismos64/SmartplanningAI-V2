...
export function UsageIndicator({
  ...
  const content = (
    <Card className={cn('glass-strong', className)} data-testid="usage-indicator">
      <CardHeader>
        ...
        <div>
          <div className="mb-2 flex items-center justify-between text-sm">
            <span className="text-muted-foreground">
              <span className="font-semibold text-foreground" data-testid="employee-count">
                {employeeCount}
              </span>{' '}
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-lg bg-muted/50 p-3">
            <div className="flex items-center gap-1">
              <Receipt className="h-3 w-3 text-muted-foreground" aria-hidden="true" />
          ...
          <div className="flex items-start gap-2 rounded-lg bg-muted/30 p-3 text-xs text-muted-foreground">
            <Tooltip>
              <TooltipTrigger asChild>
                <Info className="mt-0.5 h-3.5 w-3.5 shrink-0 cursor-help" aria-hidden="true" />
              </TooltipTrigger>
              <TooltipContent>
            ...
            <p data-testid="prorata-info">
              Chaque employé ajouté ou retiré ajuste automatiquement votre facture au prorata.
            </p>
          </div>
        </TooltipProvider>
      </CardContent>
