...
const MOCK_TEAM_MEMBERS: TeamMember[] = [
  { id: "m1", name: "Alice Petit", image: "https://i.pravatar.cc/150?u=alice", status: "active" },
  { id: "m2", name: "Bob Grand", image: "https://i.pravatar.cc/150?u=bob", status: "active" },
  { id: "m3", name: "Claire Moyen", image: null, status: "on_leave" },
  { id: "m4", name: "David Fort", image: "https://i.pravatar.cc/150?u=david", status: "active" },
  { id: "m5", name: "Emma Blanc", image: "https://i.pravatar.cc/150?u=emma", status: "absent" },
  { id: "m6", name: "François Noir", image: null, status: "active" },
  { id: "m7", name: "Gabrielle Rouge", image: "https://i.pravatar.cc/150?u=gabrielle", status: "active" },
...
const MOCK_TEAMS = [
  {
    ...
    description: "Développement des interfaces utilisateur avec React et Next.js",
    color: "#3B82F6",
  },
  {
    id: "t2",
...
export default function TestComponentsPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Test Composants Métier</h1>
      ...
      <Card className="mb-8">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-4">
                <span className="text-sm text-muted-foreground w-20">sm:</span>
                <AvatarStack members={MOCK_TEAM_MEMBERS} max={5} size="sm" />
              </div>
              <div className="flex items-center gap-4">
                <span className="text-sm text-muted-foreground w-20">md:</span>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-4">
                <span className="text-sm text-muted-foreground w-20">max=3:</span>
                <AvatarStack members={MOCK_TEAM_MEMBERS} max={3} />
              </div>
              <div className="flex items-center gap-4">
                <span className="text-sm text-muted-foreground w-20">max=5:</span>
                <AvatarStack members={MOCK_TEAM_MEMBERS} max={5} />
              </div>
              <div className="flex items-center gap-4">
                <span className="text-sm text-muted-foreground w-20">max=8:</span>
        ...
        <CardContent>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <UserCard
              ...
              status="active"
              actions={[
                { label: "Action 1", icon: Eye, onClick: () => success("Action 1") },
                { label: "Action 2", icon: Pencil, onClick: () => success("Action 2") },
                { label: "Action désactivée", icon: Settings, onClick: () => {}, disabled: true },
                { label: "Action danger", icon: Trash2, onClick: () => error("Danger!"), variant: "destructive", separator: true },
              ]}
            />
            <TeamCard
              team={MOCK_TEAMS[0]!}
              ...
              actions={[
                ...
                { label: "Éditer", icon: Pencil, onClick: () => success("Éditer") },
                { label: "Supprimer", icon: Trash2, onClick: () => error("Supprimer"), variant: "destructive", separator: true },
              ]}
            />
          </div>
        </CardContent>
      ...
      <div className="text-center text-sm text-muted-foreground">
        <p>
          Composants créés pour SP-123 | Pattern Context7 React (forwardRef,
          CVA variants)
        </p>
      </div>
    </div>
